        ...
        child: IconButton(
          ...
          onPressed: () {
            ScaffoldMessenger.of(Get.context!).showSnackBar(
              snackbar(
                Get.context!,
                "Activez la synchronisation dans les paramètres",
            ...
            return AnimatedRotation(
              ...
              child: IconButton(
                ...
                icon: Icon(
                  Icons.sync,
                  color: isConnected 
                    ? (isSyncing ? Colors.blue : Theme.of(context).iconTheme.color)
                    : Colors.grey,
                ),
                tooltip: isConnected 
                  ? (isSyncing ? "Synchronisation en cours..." : "Synchroniser les appareils appairés")
                ...
                onPressed: isSyncing ? null : () async {
                  if (!isConnected) {
                    ScaffoldMessenger.of(Get.context!).showSnackBar(
                      snackbar(
                        Get.context!, 
                        "Aucun appareil appairé connecté",
                        size: SanckBarSize.MEDIUM
                      )
                    );
                    return;
