...
import 'package:amadeusemusic/ui/screens/Library/library_controller.dart';
...
Set<SortType> buildSortTypeSet(
    ...
    bool additionOrderRequired = false]) {
  ...
  if (additionOrderRequired) {
    requiredSortTypes.add(SortType.AdditionOrder);
  }
                ...
                Row(
                  ...
                  children: [
                    ...
                    requiredSortTypes.contains(SortType.Duration)
                        ...
                        : const SizedBox.shrink(),
                    requiredSortTypes.contains(SortType.AdditionOrder)
                        ? Obx(() => _customIconButton(
                              isSelected: controller.sortType.value ==
                                  SortType.AdditionOrder,
                              tooltip: "sortByAdditionOrder".tr,
                              icon: Icons.access_time,
                              onPressed: () {
                                controller.onSortByAdditionOrder(onSort);
                              },
                            ))
                        : const SizedBox.shrink(),
...
class SortWidgetController extends GetxController {
  ...
  void onSortByAdditionOrder(Function onSort) {
    sortType.value = SortType.AdditionOrder;
    onSort(sortType.value, isAscending.value);
  }
