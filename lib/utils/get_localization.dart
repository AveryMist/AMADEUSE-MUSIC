...
,"en" : {
  ...
  "help": "Help",
  "helpSearchHint": "Search help topics...",
  "helpSections": "sections",
  "helpNoResults": "No results found",
  "helpTryDifferentKeywords": "Try different keywords",
  "helpGettingStarted": "Getting Started",
  "helpFirstLaunch": "First Launch",
  "helpFirstLaunchContent": "Welcome to AMADEUSE MUSIC! When you first launch the app, you'll see the home screen with music recommendations. You can start exploring by searching for your favorite songs or browsing the featured content.",
  "helpInterfaceOverview": "Interface Overview",
  "helpInterfaceOverviewContent": "The app has several main sections: Home (discover new music), Search (find specific songs), Library (your saved content), and Settings (customize your experience). Navigate between sections using the sidebar on PC or bottom navigation on mobile.",
  "helpBasicNavigation": "Basic Navigation",
  "helpBasicNavigationContent": "Use the sidebar on PC or bottom navigation bar on mobile to switch between different sections. Tap on any song to start playing, and use the mini-player at the bottom to control playback.",
  "helpMusicPlayback": "Music Playback",
  "helpPlayingMusic": "Playing Music",
  "helpPlayingMusicContent": "Tap any song to start playing. The mini-player appears at the bottom with basic controls. Tap the mini-player to open the full player interface with advanced controls and lyrics.",
  "helpPlayerControls": "Player Controls",
  "helpPlayerControlsContent": "The player includes play/pause, skip previous/next, shuffle, repeat modes, and volume control. You can also access the queue, lyrics, and song information from the player interface.",
  "helpQueueManagement": "Queue Management",
  "helpQueueManagementContent": "View and manage your current playing queue by tapping the queue button in the player. You can reorder songs, remove items, or clear the entire queue.",
  "helpPlayerModes": "Player UI Modes",
  "helpPlayerModesContent": "Choose between Standard Player (traditional interface) and Gesture Player (swipe-based controls) in Settings. Gesture Player allows you to swipe left/right to skip songs and double-tap to play/pause.",
  "helpLyrics": "Lyrics",
  "helpViewingLyrics": "Viewing Lyrics",
  "helpViewingLyricsContent": "Tap the lyrics button in the player to view song lyrics. Lyrics are automatically fetched when available. You can switch between synced and plain lyrics modes.",
  "helpSyncedLyrics": "Synced Lyrics",
  "helpSyncedLyricsContent": "Synced lyrics highlight the current line being sung in real-time. This provides a karaoke-like experience and helps you follow along with the music.",
  "helpPlainLyrics": "Plain Lyrics",
  "helpPlainLyricsContent": "Plain lyrics show the complete song text without timing synchronization. This is useful when synced lyrics aren't available or if you prefer to read the full lyrics at once.",
  "helpLibrary": "Library",
  "helpManagingPlaylists": "Managing Playlists",
  "helpManagingPlaylistsContent": "Create custom playlists by tapping the '+' button in the Library section. Add songs to playlists using the 'Add to Playlist' option in song menus. You can rename, reorder, or delete playlists as needed.",
  "helpFavorites": "Favorites",
  "helpFavoritesContent": "Mark songs as favorites by tapping the heart icon. Access all your favorite songs in the Library > Favorites section. Favorites are automatically synced across your devices.",
  "helpDownloads": "Downloads & Offline",
  "helpDownloadsContent": "Download songs for offline listening by using the download option in song menus. Downloaded songs are available in Library > Downloads and can be played without an internet connection.",
  "helpSearch": "Search",
  "helpSearchingMusic": "Searching for Music",
  "helpSearchingMusicContent": "Use the search function to find songs, artists, albums, or playlists. The search supports partial matches and suggests results as you type. You can also search by URL to import content.",
  "helpSearchFilters": "Search Filters",
  "helpSearchFiltersContent": "Filter search results by type (songs, artists, albums, playlists) to find exactly what you're looking for. Use the filter buttons at the top of search results.",
  "helpSettings": "Settings",
  "helpAudioSettings": "Audio Settings",
  "helpAudioSettingsContent": "Customize audio quality, enable audio effects, and configure playback settings. You can adjust streaming quality, enable skip silence, and access the system equalizer.",
  "helpThemeSettings": "Theme Settings",
  "helpThemeSettingsContent": "Choose between different theme modes: Dynamic (adapts to album artwork), Light, Dark, or System default. The dynamic theme changes colors based on the currently playing song's album art.",
  "helpLanguageSettings": "Language Settings",
  "helpLanguageSettingsContent": "Change the app language from the Settings menu. The app supports multiple languages including English, French, and others. Restart may be required for changes to take effect.",
  "helpPlayerUISettings": "Player UI Settings",
  "helpPlayerUISettingsContent": "Switch between Standard Player and Gesture Player modes. Standard mode provides traditional button controls, while Gesture mode offers swipe-based navigation for a more immersive experience.",
  "helpTroubleshooting": "Troubleshooting",
  "helpCommonIssues": "Common Issues",
  "helpCommonIssuesContent": "If you experience playback issues, check your internet connection and try restarting the app. For sync problems, ensure you're logged into the same account on all devices. Clear app cache if performance is slow.",
  "helpPerformanceTips": "Performance Tips",
  "helpPerformanceTipsContent": "To improve performance: close unused apps, ensure stable internet connection, clear app cache regularly, and restart the app if it becomes unresponsive. Consider reducing streaming quality on slower connections.",
  "helpResetSettings": "Reset Settings",
  "helpResetSettingsContent": "If you encounter persistent issues, you can reset app settings to default values in Settings > Advanced. This will restore all settings but won't affect your library or downloaded content.",
  ...
  "sortByAdditionOrder": "Sort by Addition Order",
  ...
  "exportDataDescription": "Export playlists, favorites and settings to a JSON file",
  "importData": "Import Data",
  "importDataDescription": "Import playlists, favorites and settings from a JSON file",
  "preparingExport": "Preparing export...",
  "exportAmadeuseMusicData": "Export AMADEUSE MUSIC data",
  "exportCancelledByUser": "Export cancelled by user",
  "importAmadeuseMusicData": "Import AMADEUSE MUSIC data",
  "invalidImportFile": "Invalid or corrupted import file",
  "dataImportedSuccessfully": "Data imported successfully. Restart the application to see changes.",
...
,"fr" : {
    ...
    "discover": "Découvrir",
    "trending": "Tendance",
    "topmusicvideos": "Palmarès des vidéoclips",
    ...
    "help": "Aide",
    "helpSearchHint": "Rechercher dans l'aide...",
    "helpSections": "sections",
    "helpNoResults": "Aucun résultat trouvé",
    "helpTryDifferentKeywords": "Essayez d'autres mots-clés",
    "helpGettingStarted": "Premiers Pas",
    "helpFirstLaunch": "Premier Lancement",
    "helpFirstLaunchContent": "Bienvenue dans AMADEUSE MUSIC ! Lors du premier lancement, vous verrez l'écran d'accueil avec des recommandations musicales. Vous pouvez commencer à explorer en recherchant vos chansons préférées ou en parcourant le contenu mis en avant.",
    "helpInterfaceOverview": "Aperçu de l'Interface",
    "helpInterfaceOverviewContent": "L'application comprend plusieurs sections principales : Accueil (découvrir de la musique), Recherche (trouver des chansons spécifiques), Bibliothèque (votre contenu sauvegardé), et Paramètres (personnaliser votre expérience). Naviguez entre les sections avec la barre latérale sur PC ou la navigation en bas sur mobile.",
    "helpBasicNavigation": "Navigation de Base",
    "helpBasicNavigationContent": "Utilisez la barre latérale sur PC ou la barre de navigation en bas sur mobile pour basculer entre les différentes sections. Appuyez sur n'importe quelle chanson pour commencer la lecture, et utilisez le mini-lecteur en bas pour contrôler la lecture.",
    "helpMusicPlayback": "Lecture Musicale",
    "helpPlayingMusic": "Écouter de la Musique",
    "helpPlayingMusicContent": "Appuyez sur n'importe quelle chanson pour commencer la lecture. Le mini-lecteur apparaît en bas avec les contrôles de base. Appuyez sur le mini-lecteur pour ouvrir l'interface complète du lecteur avec les contrôles avancés et les paroles.",
    "helpPlayerControls": "Contrôles du Lecteur",
    "helpPlayerControlsContent": "Le lecteur inclut lecture/pause, passer précédent/suivant, lecture aléatoire, modes de répétition, et contrôle du volume. Vous pouvez aussi accéder à la file d'attente, aux paroles, et aux informations de la chanson depuis l'interface du lecteur.",
    "helpQueueManagement": "Gestion de la File d'Attente",
    "helpQueueManagementContent": "Visualisez et gérez votre file d'attente de lecture en appuyant sur le bouton file d'attente dans le lecteur. Vous pouvez réorganiser les chansons, supprimer des éléments, ou vider toute la file d'attente.",
    "helpPlayerModes": "Modes d'Interface du Lecteur",
    "helpPlayerModesContent": "Choisissez entre le Lecteur Standard (interface traditionnelle) et le Lecteur Gestuel (contrôles par glissement) dans les Paramètres. Le Lecteur Gestuel vous permet de glisser gauche/droite pour passer les chansons et double-appuyer pour lecture/pause.",
    "helpLyrics": "Paroles",
    "helpViewingLyrics": "Affichage des Paroles",
    "helpViewingLyricsContent": "Appuyez sur le bouton paroles dans le lecteur pour voir les paroles de la chanson. Les paroles sont automatiquement récupérées quand disponibles. Vous pouvez basculer entre les modes paroles synchronisées et simples.",
    "helpSyncedLyrics": "Paroles Synchronisées",
    "helpSyncedLyricsContent": "Les paroles synchronisées surlignent la ligne actuellement chantée en temps réel. Cela offre une expérience de type karaoké et vous aide à suivre la musique.",
    "helpPlainLyrics": "Paroles Simples",
    "helpPlainLyricsContent": "Les paroles simples affichent le texte complet de la chanson sans synchronisation temporelle. C'est utile quand les paroles synchronisées ne sont pas disponibles ou si vous préférez lire toutes les paroles d'un coup.",
    "helpLibrary": "Bibliothèque",
    "helpManagingPlaylists": "Gestion des Playlists",
    "helpManagingPlaylistsContent": "Créez des playlists personnalisées en appuyant sur le bouton '+' dans la section Bibliothèque. Ajoutez des chansons aux playlists en utilisant l'option 'Ajouter à la Playlist' dans les menus des chansons. Vous pouvez renommer, réorganiser, ou supprimer les playlists selon vos besoins.",
    "helpFavorites": "Favoris",
    "helpFavoritesContent": "Marquez les chansons comme favorites en appuyant sur l'icône cœur. Accédez à toutes vos chansons favorites dans Bibliothèque > Favoris. Les favoris sont automatiquement synchronisés entre vos appareils.",
    "helpDownloads": "Téléchargements et Hors-ligne",
    "helpDownloadsContent": "Téléchargez des chansons pour l'écoute hors-ligne en utilisant l'option de téléchargement dans les menus des chansons. Les chansons téléchargées sont disponibles dans Bibliothèque > Téléchargements et peuvent être lues sans connexion internet.",
    "helpSearch": "Recherche",
    "helpSearchingMusic": "Rechercher de la Musique",
    "helpSearchingMusicContent": "Utilisez la fonction de recherche pour trouver des chansons, artistes, albums, ou playlists. La recherche supporte les correspondances partielles et suggère des résultats pendant que vous tapez. Vous pouvez aussi rechercher par URL pour importer du contenu.",
    "helpSearchFilters": "Filtres de Recherche",
    "helpSearchFiltersContent": "Filtrez les résultats de recherche par type (chansons, artistes, albums, playlists) pour trouver exactement ce que vous cherchez. Utilisez les boutons de filtre en haut des résultats de recherche.",
    "helpSettings": "Paramètres",
    "helpAudioSettings": "Paramètres Audio",
    "helpAudioSettingsContent": "Personnalisez la qualité audio, activez les effets audio, et configurez les paramètres de lecture. Vous pouvez ajuster la qualité de streaming, activer ignorer le silence, et accéder à l'égaliseur système.",
    "helpThemeSettings": "Paramètres de Thème",
    "helpThemeSettingsContent": "Choisissez entre différents modes de thème : Dynamique (s'adapte aux pochettes d'album), Clair, Sombre, ou Système par défaut. Le thème dynamique change les couleurs basées sur la pochette d'album de la chanson actuellement jouée.",
    "helpLanguageSettings": "Paramètres de Langue",
    "helpLanguageSettingsContent": "Changez la langue de l'application depuis le menu Paramètres. L'application supporte plusieurs langues incluant l'anglais, le français, et d'autres. Un redémarrage peut être requis pour que les changements prennent effet.",
    "helpPlayerUISettings": "Paramètres d'Interface du Lecteur",
    "helpPlayerUISettingsContent": "Basculez entre les modes Lecteur Standard et Lecteur Gestuel. Le mode Standard fournit des contrôles de boutons traditionnels, tandis que le mode Gestuel offre une navigation par glissement pour une expérience plus immersive.",
    "helpTroubleshooting": "Dépannage",
    "helpCommonIssues": "Problèmes Courants",
    "helpCommonIssuesContent": "Si vous rencontrez des problèmes de lecture, vérifiez votre connexion internet et essayez de redémarrer l'application. Pour les problèmes de synchronisation, assurez-vous d'être connecté au même compte sur tous les appareils. Videz le cache de l'application si les performances sont lentes.",
    "helpPerformanceTips": "Conseils de Performance",
    "helpPerformanceTipsContent": "Pour améliorer les performances : fermez les applications inutilisées, assurez-vous d'avoir une connexion internet stable, videz régulièrement le cache de l'application, et redémarrez l'application si elle ne répond plus. Considérez réduire la qualité de streaming sur les connexions plus lentes.",
    "helpResetSettings": "Réinitialiser les Paramètres",
    "helpResetSettingsContent": "Si vous rencontrez des problèmes persistants, vous pouvez réinitialiser les paramètres de l'application aux valeurs par défaut dans Paramètres > Avancé. Cela restaurera tous les paramètres mais n'affectera pas votre bibliothèque ou le contenu téléchargé.",
    ...
    "sortByAdditionOrder": "Trier par ordre d'ajout",
    "createdBy": "Créé par",
    "sourceCode": "Code source",
    "community": "Communauté",
    "joinDiscord": "Rejoindre Discord",
    "exportData": "Exporter les données",
    "exportDataDescription": "Exporter playlists, favoris et paramètres vers un fichier JSON",
    "importData": "Importer les données",
    "importDataDescription": "Importer playlists, favoris et paramètres depuis un fichier JSON",
    "preparingExport": "Préparation de l'exportation...",
    "exportAmadeuseMusicData": "Exporter les données AMADEUSE MUSIC",
    "exportCancelledByUser": "Exportation annulée par l'utilisateur",
    "importAmadeuseMusicData": "Importer les données AMADEUSE MUSIC",
    "invalidImportFile": "Fichier d'importation invalide ou corrompu",
    "dataImportedSuccessfully": "Données importées avec succès. Redémarrez l'application pour voir les changements.",
