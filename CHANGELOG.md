## 1.0.1
* Enhanced mobile lyrics visual presentation with improved formatting and readability
* Implemented comprehensive help documentation system with French and English support
* Added help buttons to player interfaces for easy access to documentation
* Verified lyrics synchronization parity between Android and PC platforms
* Universal logo implementation with new amadeuse_music.png across all platforms
* Added consistent rounded corner styling for logo displays
* Updated all platform-specific icons and configurations
* Created reusable RoundedLogoWidget for consistent branding
* Improved visual consistency across Android and Windows platforms
